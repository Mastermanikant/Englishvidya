  ...
  if (token) {
    try {
      ...
      const user = await env.DB.prepare(
        'SELECT id, google_id, email, name, username, role, avatar_url, trust_score, is_shadow_banned, daily_sync_count, monthly_sync_count, last_sync_date, last_sync_month, social_instagram, social_facebook, social_youtube, social_twitter, social_linkedin, social_pinterest, social_website1, social_website2, delete_requested_at FROM users WHERE id = ?'
